        ...
        <div className="car anc">
          ...
          <form id="clientForm">
            <div className="form-floating">
              <input type="text" className="form-control" id="clientName" placeholder="name@example.com" />
              <label htmlFor="clientName">Client Name</label>
            </div>
            <div className="form-floating">
              <input type="text" className="form-control" id="clientPhone" placeholder="name@example.com" />
